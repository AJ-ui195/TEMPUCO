...
<div class="mp-stack">
    ...
    <div>
        ...
        <div class="mp-stat-grid" style="margin-top: 1rem;">
            ...
            <div class="mp-stat-card">
                <div class="mp-stat-card-header">
                    <span class="mp-stat-label">{{ __('Loyalty points') }}</span>
                    <span class="mp-stat-icon" aria-hidden="true">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="18" height="18"><path fill-rule="evenodd" d="M10 1a.75.75 0 0 1 .673.418l2.226 4.66 5.084.74a.75.75 0 0 1 .417 1.28l-3.706 3.568.875 5.05a.75.75 0 0 1-1.092.79L10 15.187l-4.477 2.39a.75.75 0 0 1-1.092-.79l.875-5.05L1.6 8.098a.75.75 0 0 1 .417-1.28l5.084-.74 2.226-4.66A.75.75 0 0 1 10 1Z" clip-rule="evenodd"/></svg>
                    </span>
                </div>
                <div class="mp-stat-value">{{ (int) $user->points }}</div>
                <p class="mp-stat-hint">{{ __('Earn 1 point per ₱200+ purchase') }}</p>
            </div>
