...
/* Everything prints solid black and bold: thermal paper dithers grey into a faint, hard-to-read result. */
body {
    margin: 0;
    padding: 0;
...
.pos-receipt-paper__muted { color: #000; }
...
.pos-receipt-paper__divider { border-top: 1px dashed #000; margin: 0.625rem 0; }
