...
return new class extends Migration
{
    public function up(): void
    {
        CharacterLoan::query()->each(function (CharacterLoan $loan): void {
            $start = $loan->loan_date ?? $loan->applicant_signed_at ?? $loan->approved_at ?? $loan->created_at;
    ...
    public function down(): void
    {
        CharacterLoan::query()->each(function (CharacterLoan $loan): void {
            ...
            $loan->first_payment_due_date = Carbon::parse($start)->addMonthNoOverflow()->toDateString();
            $loan->saveQuietly();
        });
    }
};
