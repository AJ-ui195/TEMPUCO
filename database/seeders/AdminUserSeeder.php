...
class AdminUserSeeder extends Seeder
{
     ...
     * After login: change temporary password, then set up authenticator MFA.
     */
    public function run(): void
    {
        ...
        $this->command?->warn('Sign in at /admin/login, change the temporary password, then complete MFA setup.');
    }
}
